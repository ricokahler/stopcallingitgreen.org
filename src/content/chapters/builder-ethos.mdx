...
sources:
  ...
  - title: "Wikimedia Commons, \"Installing Solar Panels\""
    url: "https://commons.wikimedia.org/wiki/File:Installing_Solar_Panels_(7336033672).jpg"
---

import BookImage from '../../components/BookImage.astro';
import installingSolarPanels from '../../assets/visuals/installing-solar-panels-doe.jpg';

The future does not have to look like a climate conference.

<BookImage
  src={installingSolarPanels}
  alt={"Workers installing solar panels on a roof structure."}
  caption={"The useful version of the future looks like work: equipment, crews, wiring, maintenance, and tools that solve material problems."}
  creditHref={"https://commons.wikimedia.org/wiki/File:Installing_Solar_Panels_(7336033672).jpg"}
  creditLabel={"Public-domain DOE photo via Wikimedia Commons"}
  wide
  priority
  position={"center 45%"}
/>
