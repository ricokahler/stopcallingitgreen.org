...
Why was the show made? The boring answer is probably the true answer: a streaming company wanted a hit, Taylor Sheridan had become one of Paramount's most valuable hitmakers, and the Texas oil patch is an obviously dramatic setting. *Landman* was developed from *Boomtown*, a Texas Monthly podcast about the Permian Basin. Paramount later bragged that the premiere drew more than five million global viewers across Paramount+ and a linear preview. That is the first incentive. Not oil. Attention.

That matters because it keeps the accusation clean. I cannot prove API funded the show. I cannot prove API wrote the wind speech. API's president told Axios the group was not involved and did not know where the speech came from. Fine.

The better evidence is more interesting anyway.

API did not simply cheer the show from the sidelines. During season one, the Midland Reporter-Telegram reported that API bought a seven-figure ad campaign to counter what it saw as the show's negative portrayal of the oil business. That is not evil. That is an industry association doing what industry associations do: protecting its workforce image, its political legitimacy, and its permission to operate.
