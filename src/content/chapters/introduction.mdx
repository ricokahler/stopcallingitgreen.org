...
Solar is not perfect. Wind is not perfect. Batteries are not perfect. Every energy system has tradeoffs, because energy is the part of civilization where physics walks into politics and asks for a land-use hearing.
...
Apply one standard. If a new machine has to answer for its costs, the familiar fuel system should answer for its costs too.
...
The United States already gets electricity from a mix of sources: natural gas, coal, nuclear, hydro, wind, solar, and more. Solar is not some imaginary boutique future. EIA, Lazard, and NREL all point to the same boring reality: solar is already meaningful, still growing, often cheap to build, and usually durable once installed.
...
This is where the culture war does its worst work. It turns material problems into moral dramas. Instead of asking, "What does this machine do, what does it cost, and who benefits if we do not build it?", we ask, "What kind of person wants this machine?"
...
The point up front is simple: this argument should be able to survive contact with real skepticism.
